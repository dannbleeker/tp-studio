...
- No `MUTATION_BASELINE.md`, no CI gate. The `paletteScore.ts → 88.24%` data point from Session 121 stays in the Stryker config header as a recorded example; it's the only score we'll publish until a future nightly-CI proposal earns one.
