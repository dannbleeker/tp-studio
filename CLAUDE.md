...
**Headless verification harness (no browser needed — the fast default; the old "Playwright Chromium is AppLocker-blocked" reason no longer applies at `C:\devtools`, but headless geometry is still quicker for canvas checks):**
