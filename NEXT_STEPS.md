...
>
> **Verb-scope follow-ups (Sessions 96–97 + 127):** Mark as UDE / root cause (96), add-NC-child / promote-to-goal (96), add-prerequisite-need (97), cycle-edge-polarity (97), cycle-group-color (97), Spawn EC from selection / Start Negative Branch / Mark as CSF (127). The registry now covers the main per-diagram practitioner verbs across CRT / FRT / Goal Tree / EC. Future scope: TT (action / outcome) and PRT (obstacle / intermediate objective) workflows aren't yet first-class verbs.
