...
- **Multi-document tabs** — *Session 137 deep-planned + Batch 1 shipping.* See [docs/MULTI_DOC_TABS_PLAN.md](docs/MULTI_DOC_TABS_PLAN.md) for the 6-phase arc (46–68 hours total) with all 7 design questions answered. Batch 1 is the invisible-refactor Phase 1 — pays back even if tabs never ship; phases 2–6 ride on top whenever Dann is ready.
