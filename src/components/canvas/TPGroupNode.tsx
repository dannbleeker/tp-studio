  ...
  return (
    ...
    >
      <button
        type="button"
        className={clsx(
          'pointer-events-auto absolute -top-2.5 left-3 cursor-pointer rounded-md bg-white px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide shadow-sm dark:bg-neutral-950',
          colors.text
        )}
        onClick={(e) => {
          e.stopPropagation();
