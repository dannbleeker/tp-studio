...
<footer class="footer">
  <!-- Session 98 — was an inert <a href="#" onclick="return false;">.
       The link did nothing functionally (just kept the underline) but
       looked like an event handler to a security skim. A <span> is
       semantically honest. -->
  Generated by <span class="brand">TP Studio</span> · Self-contained · No network calls
</footer>
